...
separate the two variance sources---and, in our data, the separation
reverses the naive conclusion.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.78\textwidth]{../results/figures/divergence_vs_depth.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.78\textwidth]{../results/figures/per_task_curves.pdf}
...
\subsection{Raw divergence grows weakly---and not uniformly---with depth}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.78\textwidth]{../results/figures/success_vs_depth.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.78\textwidth]{../results/figures/divergence_violins.pdf}
